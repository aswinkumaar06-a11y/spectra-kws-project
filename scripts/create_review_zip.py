...
STAGING_DIR = os.path.join(PROJECT_ROOT, "Spectra_Arena_Review")
ZIP_PATH = os.path.join(PROJECT_ROOT, "Spectra_Arena_Review.zip")
...
# 6. Root files
for rf in ["run_pipeline.bat", "requirements.txt", "README.md", "arena_handover_report.md", "walkthrough.md", "revision.txt"]:
